      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form class="form-inline my-2 my-lg-0">
          ...
          <?php
            ...
            echo '<p align="center"><a href="logout.php" class="btn btn-dark btn-block">Cerrar Sesión</a></p>';
            ?>
        </form>
      </div>
</nav>
 ...
 <div class="container">
     <div class="row mt-5">
         ...
         <form action="index.php" method="post"> 
            <div class="dropdown">
                <select class="btn btn-secondary dropdown-toggle" id="cboejercicio" name="cboejercicio">
    ...
    try 
       {
            ...
            /* código para poner botones */
                    ...
                    if ($rene==1){
                        echo "<button type='button' class='btn btn-outline-dark btn-sm m-0 waves-effect' onclick='muestra_pdf(1);' >Ene</button>";
                    }else{
                        echo "<button type='button' class='btn btn-outline-dark btn-sm m-0 waves-effect' disabled='disabled'>Ene</button>";
                    }                
                    echo "</td>";
                    echo "<td>";
                    if ($rfeb==1){
                        echo "<button type='button' class='btn btn-outline-success btn-sm m-0 waves-effect' onclick='muestra_pdf(2);' >Feb</button>";
                    }else{
                        echo "<button type='button' class='btn btn-outline-success btn-sm m-0 waves-effect' disabled='disabled'>Feb</button>";
                    }                
                    echo "</td>";
                    echo "<td>";
